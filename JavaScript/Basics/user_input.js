...
/**
 * Demonstrates that user input can be stored and printed.
 */
function demonstrateStoringInput() {
...
demonstrateStoringInput();

/**
 * Demonstrates converting user input to an integer using `parseInt`.
 * 
...
/**
 * Demonstrates how a decimal number loses its fractional part with `parseInt`.
 * 
...
/**
 * Demonstrates how to use parseFloat to handle decimal values in calculations.
 */
function demonstrateDecimalCorrection() {
